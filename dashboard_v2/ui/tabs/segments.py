    ...
    with col1:
        ...
        with c:
            if market_df.empty:
                ...
                agg["_desc"] = agg["market_code"].apply(lambda x: t_code("market_code", x))
                st.altair_chart(
                    alt.Chart(agg).mark_bar(
                        ...
                        tooltip=[
                            alt.Tooltip("market_code:N", title="Mã/Code"),
                            alt.Tooltip("_desc:N", title=t("axis.segment")),
                            alt.Tooltip("room_nights:Q", format=",.0f", title=t("axis.room_nights")),
                        ],
    ...
    with col2:
        ...
        with c:
            if source_df.empty:
                ...
                agg["_desc"] = agg["source_of_business"].apply(lambda x: t_code("source_of_business", x))
                st.altair_chart(
                    alt.Chart(agg).mark_bar(
                        ...
                        tooltip=[
                            alt.Tooltip("source_of_business:N", title="Mã/Code"),
                            alt.Tooltip("_desc:N", title=t("axis.source")),
                            alt.Tooltip("room_nights:Q", format=",.0f", title=t("axis.room_nights")),
                        ],
                    ).properties(height=280),
                    use_container_width=True,
    ...
    with col3:
        ...
        with c:
            if rate_df.empty:
                ...
                agg["_desc"] = agg["rate_plan_code"].apply(lambda x: t_code("rate_plan_code", x))
                st.altair_chart(
                    alt.Chart(agg).mark_bar(
                        color=BAR_COLOR, cornerRadiusTopLeft=3, cornerRadiusTopRight=3
                    ).encode(
                        ...
                        y=alt.Y("room_nights:Q", title=t("axis.room_nights")),
                        tooltip=[
                            alt.Tooltip("rate_plan_code:N", title="Mã/Code"),
                            alt.Tooltip("_desc:N", title="Gói giá / Rate Plan"),
                            alt.Tooltip("room_nights:Q", format=",.0f", title=t("axis.room_nights")),
                        ],
                    ).properties(height=280),
                    use_container_width=True,
    ...
    with col4:
        ...
        with c:
            if room_df.empty:
                ...
                agg["_desc"] = agg["room_type"].apply(lambda x: t_code("room_type", x))
                st.altair_chart(
                    alt.Chart(agg).mark_bar(
                        color=BAR_COLOR, cornerRadiusTopRight=3, cornerRadiusBottomRight=3
                    ).encode(
                        ...
                        x=alt.X("room_nights:Q", title=t("axis.room_nights")),
                        tooltip=[
                            alt.Tooltip("room_type:N", title="Mã/Code"),
                            alt.Tooltip("_desc:N", title=t("axis.room_type")),
                            alt.Tooltip("room_nights:Q", format=",.0f", title=t("axis.room_nights")),
                        ],
                    ).properties(height=280),
                    use_container_width=True,
