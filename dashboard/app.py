...
with c_from:
    start_date = st.date_input(t("filter.from"), value=today - timedelta(days=DEFAULT_DATE_RANGE_DAYS), key="from_input")
with c_to:
    end_date = st.date_input(t("filter.to"), value=today, key="to_input")
with c_30:
